...
<div class="coreteammember-edit front-end-edit">
...
<?php if ($this->params->get('show_page_heading')) : ?>
	...
	<?php else : ?>
		...
		<form id="form-coreteammember"
			  action="<?php echo Route::_('index.php?option=com_ccpbiosim&task=coreteammemberform.save'); ?>"
	...
	<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'coreteammember')); ?>
	<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'coreteammember', Text::_('COM_CCPBIOSIM_TAB_CORETEAMMEMBER', true)); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<a class="btn btn-danger"
					   href="<?php echo Route::_('index.php?option=com_ccpbiosim&task=coreteammemberform.cancel'); ?>"
