...
<div class="eventcategory-edit front-end-edit">
...
<?php if ($this->params->get('show_page_heading')) : ?>
	...
	<?php else : ?>
		...
		<form id="form-eventcategory"
			  action="<?php echo Route::_('index.php?option=com_ccpbiosim&task=eventcategoryform.save'); ?>"
			...
			<div class="control-group">
				<div class="controls">
					...
					<a class="btn btn-danger"
					   href="<?php echo Route::_('index.php?option=com_ccpbiosim&task=eventcategoryform.cancel'); ?>"
