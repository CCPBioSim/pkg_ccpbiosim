...
namespace Ccpbiosim\Component\Ccpbiosim\Administrator\View\Event;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_CCPBIOSIM_TITLE_EVENT'), "generic");
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			ToolbarHelper::versions('com_ccpbiosim.event', $this->item->id);
		}
