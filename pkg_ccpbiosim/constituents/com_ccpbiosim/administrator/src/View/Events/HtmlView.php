...
namespace Ccpbiosim\Component\Ccpbiosim\Administrator\View\Events;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_CCPBIOSIM_TITLE_EVENTS'), "generic");
		...
		// Set sidebar action
		Sidebar::setAction('index.php?option=com_ccpbiosim&view=events');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => Text::_('COM_CCPBIOSIM_EVENTS_TITLE'),
