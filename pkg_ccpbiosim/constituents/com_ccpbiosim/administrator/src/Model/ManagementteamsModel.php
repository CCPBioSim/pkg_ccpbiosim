...
/**
 * Methods supporting a list of Managementteams records.
 *
 */
class ManagementteamsModel extends ListModel
{
	...
	*/
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__ccpbiosim_management_team` AS a');
	...
	public function getItems()
	{
		...
		{
					$oneItem->title = !empty($oneItem->title) ? Text::_('COM_CCPBIOSIM_MANAGEMENTTEAMS_TITLE_OPTION_' . preg_replace('/[^A-Za-z0-9\_-]/', '',strtoupper(str_replace(' ', '_',$oneItem->title)))) : '';
		}
