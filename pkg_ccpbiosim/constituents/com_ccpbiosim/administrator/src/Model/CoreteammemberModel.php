 ...
 *
 */
class CoreteammemberModel extends AdminModel
{
	/**
	 ...
	 *
	 */
	public $typeAlias = 'com_ccpbiosim.coreteammember';
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_ccpbiosim.coreteammember', 
					'coreteammember',
					array('control' => 'jform',
					      'load_data' => $loadData));
	...
	/**
	 * Method to duplicate an Coreteammember
	 *
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__ccpbiosim_core_team');
				$max             = $db->loadResult();
