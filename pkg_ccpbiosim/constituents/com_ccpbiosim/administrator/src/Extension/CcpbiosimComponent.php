...
/**
 * Component class for Ccpbiosim
 */
class CcpbiosimComponent extends MVCComponent implements RouterServiceInterface, BootableExtensionInterface, CategoryServiceInterface
{
