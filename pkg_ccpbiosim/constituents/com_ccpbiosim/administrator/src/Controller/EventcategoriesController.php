...
/**
 * Eventcategories list controller class.
 */
class EventcategoriesController extends AdminController
{
	/**
	 * Method to clone existing Eventcategories
	 *
	 * @return  void
	 *
	 * @throws  Exception
	 ...
	 */
	public function getModel($name = 'Eventcategory', $prefix = 'Administrator', $config = array())
	{
