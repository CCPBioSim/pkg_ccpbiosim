...
/**
 * Coreteammember table
 *
 */
class CoreteammemberTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_ccpbiosim.coreteammember';
		parent::__construct('#__ccpbiosim_core_team', 'id', $db);
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!$user->authorise('core.admin', 'com_ccpbiosim.coreteammember.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_ccpbiosim/access.xml',
				"/access/section[@name='coreteammember']/"
			);
			$default_actions = Access::getAssetRules('com_ccpbiosim.coreteammember.' . $array['id'])->getData();
			$array_jaccess   = array();
