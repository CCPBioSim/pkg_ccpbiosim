...
class EventTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_ccpbiosim.event';
		parent::__construct('#__ccpbiosim_events', 'id', $db);
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!$user->authorise('core.admin', 'com_ccpbiosim.event.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_ccpbiosim/access.xml',
				"/access/section[@name='event']/"
			);
			$default_actions = Access::getAssetRules('com_ccpbiosim.event.' . $array['id'])->getData();
			$array_jaccess   = array();
